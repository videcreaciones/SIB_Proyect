...
def process_canvas(frame, results, canvas, viewport_top_left, params):
    ...
    if results.multi_hand_landmarks:
        for hand_landmarks in results.multi_hand_landmarks:
            # Verificar si el gesto "Shaka" está presente para mover la vista
            ...
            # Lógica de dibujo basada en el gesto y proximidad entre dedos
            process_gesture(hand_landmarks, width, height, canvas, proximity_threshold=params["proximity_threshold"])

            # Dibujar un marcador visual para la punta del índice
